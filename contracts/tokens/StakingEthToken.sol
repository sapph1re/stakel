...
contract StakingEthToken is IStakingEthToken, BaseERC20 {
    ...
    // @dev Minter Address allowed to mint tokens whenever they choose
    ...
    function initialize(address _rewardEthToken, address _settings, address _pool) public override initializer {
        super.initialize("Liquid ETH", "LETH");
    ...
    function mint(address account, uint256 amount) external override {
        require(msg.sender == pool || msg.sender == minter, "StakingEthToken: permission denied");
